                        ...
                        <div class="col-lg-4 pt-4">
                            <div class="card alert-warning" style="height: 100%">
                                ...
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Modal'.$recept[7].'">Mutasd a receptet</button>
                                    
                                </div>
                            </div>
                        </div>
                        <div class="modal" id="Modal'.$recept[7].'">
                            <div class="modal-dialog">
                                <div class="modal-content">

                                <!-- Modal Header -->
                                <div class="modal-header">
                                    <h4 class="modal-title">'.$recept[0].'</h4>
